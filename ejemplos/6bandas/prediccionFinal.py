...
df = pd.read_csv('../6bandas/resultados/resultados6bandas-juntos/kNN/predicciones_con_variedad_kNN_juntos.csv')
...
df_final.to_csv('../6bandas/resultados/resultados6bandas-juntos/kNN/predicciones_con_variedad_kNN_juntos.csv', index=False)

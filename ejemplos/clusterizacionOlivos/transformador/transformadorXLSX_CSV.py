...
prueba_ar = ar_rows.sample(n=10, random_state=42)
...
modelo_df.to_csv("../../../archivos/archivosRefactorizados/clusterizacionOlivos/DatosModeloPicual_3.csv", index=False)

prueba_df = pd.concat([prueba_ar, prueba_no_ar])
prueba_df.to_csv("../../../archivos/archivosRefactorizados/clusterizacionOlivos/DatosPruebaPicual_3.csv", index=False)
